...
//!
//! Key Features:
//! #[require] Macro: Enforces that a method can only be called when certain states are active.
//! #[switch_to] Macro: Modifies the return type of methods to switch between states.
//! #[states] Macro: Defines the valid states for a given type and generates corresponding marker structs and trait implementations.
//! #[type_state] Macro: Creates a struct with state slots and default states.
